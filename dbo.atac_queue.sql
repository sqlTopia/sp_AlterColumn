...
CREATE TABLE    atac_queue
                (
                        ...
                        CONSTRAINT ck_atac_queue_action_code_sort_order_phase CHECK     (
                                                                                                ...
                                                                                                OR action_code = 'diix' AND sort_order =  60 AND phase = 3      -- Disable index
                                                                                                OR action_code = 'drix' AND sort_order =  70 AND phase = 3      -- Drop index
                                                                                                OR action_code = 'drvw' AND sort_order =  80 AND phase = 3      -- Drop view
                                                                                                OR action_code = 'drfn' AND sort_order =  90 AND phase = 3      -- Drop function
                                                                                                OR action_code = 'dick' AND sort_order = 100 AND phase = 3      -- Disable table check constraint
                                                                                                OR action_code = 'drck' AND sort_order = 110 AND phase = 3      -- Drop table check constraint
                                                                                                OR action_code = 'drdk' AND sort_order = 120 AND phase = 3      -- Drop table default constraint
                                                                                                OR action_code = 'drcc' AND sort_order = 130 AND phase = 3      -- Drop computed column
                                                                                                OR action_code = 'undf' AND sort_order = 140 AND phase = 3      -- Unbind column default
                                                                                                OR action_code = 'drdf' AND sort_order = 150 AND phase = 3      -- Drop column default
                                                                                                OR action_code = 'unru' AND sort_order = 160 AND phase = 3      -- Unbind column rule
                                                                                                OR action_code = 'drru' AND sort_order = 170 AND phase = 3      -- Drop column rule

                                                                                                OR action_code = 'tsql' AND sort_order = 180 AND phase = 4      -- User supplied t-sql statements

                                                                                                OR action_code = 'aldb' AND sort_order = 190 AND phase = 5      -- Alter database

                                                                                                OR action_code = 'alco' AND sort_order = 200 AND phase = 6      -- Alter column

                                                                                                OR action_code = 'reco' AND sort_order = 210 AND phase = 7      -- Rename a column

                                                                                                OR action_code = 'tsql' AND sort_order = 220 AND phase = 8      -- User supplied t-sql statements

                                                                                                OR action_code = 'crru' AND sort_order = 230 AND phase = 9      -- Create column rule
                                                                                                OR action_code = 'biru' AND sort_order = 240 AND phase = 9      -- Bind column rule
                                                                                                OR action_code = 'crdf' AND sort_order = 250 AND phase = 9      -- Create column default
                                                                                                OR action_code = 'bidf' AND sort_order = 260 AND phase = 9      -- Bind column default
                                                                                                OR action_code = 'crcc' AND sort_order = 270 AND phase = 9      -- Create computed column
                                                                                                OR action_code = 'crdk' AND sort_order = 280 AND phase = 9      -- Create table default constraint
                                                                                                OR action_code = 'crck' AND sort_order = 290 AND phase = 9      -- Create table check constraint
                                                                                                OR action_code = 'enck' AND sort_order = 300 AND phase = 9      -- Enable table check constraint
                                                                                                OR action_code = 'crfn' AND sort_order = 310 AND phase = 9      -- Create function
