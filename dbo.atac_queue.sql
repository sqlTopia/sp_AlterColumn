...
CREATE TABLE    dbo.atac_queue
                (
                        ...
                        CONSTRAINT ck_atac_queue_action_code_sort_order_phase CHECK     (
                                                                                                ...
                                                                                                OR action_code = N'undf' AND sort_order =  70 AND phase = 3     -- Unbind column default
                                                                                                OR action_code = N'unru' AND sort_order =  80 AND phase = 3     -- Unbind column rule
                                                                                                OR action_code = N'prfx' AND sort_order =  90 AND phase = 3     -- Any statement request by user to be run before alter column
                                                                                                OR action_code = N'alco' AND sort_order = 100 AND phase = 3     -- Alter column
                                                                                                OR action_code = N'sffx' AND sort_order = 110 AND phase = 3     -- Any statement request by user to be run after alter column
                                                                                                OR action_code = N'reco' AND sort_order = 120 AND phase = 3     -- Rename a column
                                                                                                OR action_code = N'biru' AND sort_order = 130 AND phase = 3     -- Bind column rule
                                                                                                OR action_code = N'bidf' AND sort_order = 140 AND phase = 3     -- Bind column default
                                                                                                OR action_code = N'crcc' AND sort_order = 150 AND phase = 3     -- Create computed column
                                                                                                ...
                                                                                                OR action_code = N'difk' AND sort_order = 220 AND phase = 4     -- Disable foreign key
                                                                                                OR action_code = N'entg' AND sort_order = 230 AND phase = 5     -- Enable table triggers
                                                                                                OR action_code = N'remo' AND sort_order = 240 AND phase = 5     -- Refresh modules
                                                                                                OR action_code = N'endt' AND sort_order = 250 AND phase = 6     -- Enable database triggers
                                                                                        ),
                );
GO
